...
Recently, I've been delving into the architecture of production-grade inference engines. While projects like vLLM and SGLang are impressive, their complexity can make detailed code tracing difficult. Over the holidays, I came across [nano-vllm](https://github.com/GeeeekExplorer/nano-vllm)—a tightly scoped codebase that still delivers end-to-end support for Page Attention and scheduling. I took a deep dive into its internals and have compiled my technical notes here.
